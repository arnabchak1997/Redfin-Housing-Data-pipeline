...
job_flow_overrides = {
    ...
    "LogUri": "s3://redfin-data-project-ap-southeast-1-515678466614/emr-logs/",
    ...
    "Instances": {
        ...
        "Ec2SubnetId": "subnet-0f1d73e57843f7729",
        "Ec2KeyName" : 'redfine-ec2-keypair',
...
SPARK_STEPS_EXTRACTION = [
    {
        ...
        "HadoopJarStep": {
            ...
            "Args": [
                "s3://redfin-data-project-ap-southeast-1-515678466614/scripts/ingest.sh",
            ],
        },
    },
   ]
...
SPARK_STEPS_TRANSFORMATION = [
    {
        ...
        "HadoopJarStep": {
            ...
            "Args": ["spark-submit",
            "s3://redfin-data-project-ap-southeast-1-515678466614/scripts/transform_redfin_data.py",
            ],
        },
    },
   ]
